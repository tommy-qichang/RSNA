...
-- Bx128x1x15x15
vgg:add(nn.GPU(ConvBNReLU(128, 256):add(nn.Dropout(0.4)),3,4))
...
-- Bx256x1x7x7
vgg:add(nn.GPU(ConvBNReLU(256, 512):add(nn.Dropout(0.4)),3,4))
...
print(fcnn:cuda():forward(torch.CudaTensor(1,1,5,512,512)):size())
